...
$nama_upload = $_POST['nama'];
$tanggal_upload = $_POST['tanggal'];
$tipe_berita = $_POST['tipe'];
...
$sql = "INSERT INTO webta (id, Nama_berita, Isi_berita, Nama_upload, Waktu, Tipe, Gambar) VALUES ('','$judul_berita','$isi_berita3','$nama_upload','$tanggal_upload','$tipe_berita','$gambar_berita')";
