...
<body>
        ...
        <div>
            <ul>
              <a class="btn btn-primary ml-lg-3" href="Beranda.php">Back to Home</a>
            </ul>
        </div> <!-- .navbar-collapse -->
